          ...
          >             
            ...
            <div className="space-y-3 sm:space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3">
                ...
                <button
                  onClick={() => setShowEasterEgg(false)}
                  className="bg-slate-700/80 hover:bg-slate-600/80 text-white hover:text-slate-300 font-semibold px-5 py-3 rounded-xl flex items-center justify-center gap-2 transition-all duration-300 transform hover:scale-105 border border-slate-600/50 backdrop-blur-sm"
                >
